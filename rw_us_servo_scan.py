...
#
############################################################################################
# Alan: changed from gopigo to goRWpigo for my bot
...
def us_map():
	...
	#                           # Alan - use an odd number of readings so there is a center reading
	num_of_readings=91		#Number of readings to take 
	i_center_reading = int(num_of_readings/2+1)  # Alan remember index of center reading
	#                               # Alan: 180.0 to get increment as a float
	incr=180.0/num_of_readings	#increment of angle in servo
	...
	for i in range(grid_size/2):
		...
		print "|"
	print fence*2
	# Alan: change to return the distance at servo(90) - straight ahead
	#return min(dist_l) #Return the closest distance in all directions
	print "dist_l[i_center_reading]: %d ang_l= %d" % (dist_l[i_center_reading],ang_l[i_center_reading])
	return(dist_l[i_center_reading]) 
